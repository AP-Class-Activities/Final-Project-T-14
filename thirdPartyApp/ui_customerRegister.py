...
# Form implementation generated from reading ui file 'qt_customer.ui'
#
...
"")
        ...
        self.label_18.setGeometry(QtCore.QRect(80, 210, 171, 21))
    ...
    def save_data(self):
        ...
        f.write('\n' + ui_customer.customer_id() + ' ' + self.lineEdit.text() + ' ' + self.lineEdit_2.text() + ' ' + 
